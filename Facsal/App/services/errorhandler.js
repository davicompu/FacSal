            ...
            var ctor = function (targetObject) {
                ...
                this.handleError = function (error) {
                    if (error.entityErrors) {
                        error.message = utils.getSaveValidationErrorMessage(error);
                    }

                    return logger.logError(error.message, null, system.getModuleId(targetObject), true);
                };
